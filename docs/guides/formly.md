...
| tooltip                        | Adds a tooltip to a field. Includes `<ish-field-tooltip>` component.                                                                                                                                                    | `tooltip`: `{ text: string; link: string; title?: string; class?: string}` that defines the different tooltip parameters.    |
